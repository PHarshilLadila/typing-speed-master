...
class ResultsScreen extends StatefulWidget {
  ...
  final bool isViewDetails;
  final bool shouldSaveResult;
  final String? from; // Add this parameter to know where we came from
...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  void _onBackToTest() {
    // Update router provider to select test tab
  ...
  void _onBackToDashboard() {
    // Update router provider to select dashboard tab
    final routerProvider = Provider.of<RouterProvider>(context, listen: false);
