...
//   //       profileTags('Avg: ${user.averageWpm.round()} WPM', isDark),
//   //     ],
//   //   );
//   // }
//   Widget profileUserTags(UserModel user, bool isDark, bool isMobile) {
...
//   //             _buildStatItem(
//   //               'Average WPM',
//   //               '${user.averageWpm.round()}',
//   //               Icons.speed,
//   //               isDark,
//   //             ),
//   //             _buildStatItem(
//   //               'Accuracy',
//   //               '${user.averageAccuracy.round()}%',
//   //               Icons.percent,
//   //               isDark,
//   //             ),
//   //             _buildStatItem(
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> _loadProfileData() async {
    ...
    if (authProvider.isLoggedIn && authProvider.user != null) {
      // Force refresh profile data on first load
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        // Auto-refresh when profile screen becomes visible and user is logged in
        if (authProvider.isLoggedIn &&
