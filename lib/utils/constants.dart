class AppConstants {
  static const List<String> sampleTexts = [
    "the quick brown fox jumps over the lazy dog while programming in flutter web",
    "typing speed tests help improve your keyboard skills and accuracy over time with consistent practice",
    "Flutter is Google's UI toolkit for building beautiful applications for mobile, web, and desktop from a single codebase",
