...
//         child: Stack(
//           children: [
//             // Background falling elements - properly positioned
...
//                   if (!isMobile) ...[
//                     const Spacer(),
//                     // Trapezoid game area for desktop
...
//                             22 // little bigger for less overlap chance
...
//               // Store rect to avoid further collisions
...
//       angle: random.nextDouble() * 0.2 - 0.1, // Slight rotation
//       child: Container(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          ...
                          size: 18,
                          color:
                              gameCard.isFavorite ? Colors.amber : Colors.grey,
                        ),
                      ),
                    ],
                  ),
